...
const ChaptersPage = async ({
  ...
  return (
    <>
    {!isPublished && (
        <Banner variant="warning" label="This chapter is unpublished this will not be visible in course"/>
    )}
    <div className="p-6">
      <div className="flex items-center justiyfy-between">
        <div className="w-full">
          ...
          >
            <ArrowLeft className="h-4 w-4 mr-2">Back to course setup</ArrowLeft>
          </Link>
